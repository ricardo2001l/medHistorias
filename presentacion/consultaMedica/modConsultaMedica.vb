...
Public Class modConsultaMedica
    ...
    Private Sub modConsultaMedica_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        If Me.cmbCedulaMedico.Text <> "" And Me.cmbCedulaPaciente.Text <> "" And Me.txtMotivo.Text <> "" And Me.txtPeso.Text <> "" And Me.txtAltura.Text <> "" And Me.txtSintomas.Text <> "" And Me.txtDiagnostico.Text <> "" Then
            ...
            EXEerror = fc.modificar(ec._codConsulta, ec._cedulaMedico, ec._cedulaPaciente, ec._fecha, ec._motivo, ec._peso, ec._altura, ec._sintomas, ec._diagnostico)


            If Not EXEerror Then
                MsgBox("la consulta Médica se ha modificado correctamente.", MsgBoxStyle.Information, "Ejecución correcta")
                limpiarControles(True)
            End If

        Else
            MsgBox("Tiene que llenar todos los campos para modificar una consulta médica", MsgBoxStyle.Critical, "Le falta un campo por llenar")
        End If
    End Sub
