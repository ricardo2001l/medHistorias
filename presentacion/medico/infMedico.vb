Imports entidad
Imports datos
Public Class infMedico
    Dim fpdf As New Fpdf
    Dim fm As New Fmedico
    Dim em As New Emedico
    Private Sub infMedico_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnInforme_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInforme.Click
        If Me.cmbCedula.Text = "Todos" Then
            fpdf.iniciarPdf("Medico", "Todos")
        Else
            fpdf.iniciarPdf("Medico", "Una", cedulaPaciente:=Me.cmbCedula.Text)
        End If
